...
class Plugin {
	...
	private function admin_i18n() {
		return [
			...
			'bundlesHero'       => __( 'Group products into promotions with tiered quantity discounts, then drop them anywhere with a shortcode.', 'bundlecraft-for-woocommerce' ),
			'total'             => __( 'total', 'bundlecraft-for-woocommerce' ),
			'enabledLabel'      => __( 'enabled', 'bundlecraft-for-woocommerce' ),
			'unnamed'           => __( 'Untitled', 'bundlecraft-for-woocommerce' ),
			'emptyTitle'        => __( 'No bundles yet', 'bundlecraft-for-woocommerce' ),
			'emptyHint'         => __( 'Create your first bundle: pick products, set quantity tiers, and publish it with a shortcode.', 'bundlecraft-for-woocommerce' ),
			'backToList'        => __( 'All bundles', 'bundlecraft-for-woocommerce' ),
			'tabProducts'       => __( 'Products', 'bundlecraft-for-woocommerce' ),
			'tabDiscounts'      => __( 'Discounts', 'bundlecraft-for-woocommerce' ),
			'tabDesign'         => __( 'Design', 'bundlecraft-for-woocommerce' ),
			'livePreview'       => __( 'Live preview', 'bundlecraft-for-woocommerce' ),
			'previewNote'       => __( 'A rough sketch of the storefront widget — the real one inherits your theme styles.', 'bundlecraft-for-woocommerce' ),
			'tierItemsOrMore'   => __( 'items +', 'bundlecraft-for-woocommerce' ),
			'tierOff'           => __( 'off', 'bundlecraft-for-woocommerce' ),
			'colorsLabel'       => __( 'Colors', 'bundlecraft-for-woocommerce' ),
			'addToCart'         => __( 'Add to Cart', 'bundlecraft-for-woocommerce' ),
			'updated'           => __( 'Bundle updated.', 'bundlecraft-for-woocommerce' ),
